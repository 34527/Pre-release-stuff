...
def CheckMoveIsLegal(Board, StartRank, StartFile, FinishRank, FinishFile, WhoseTurn):
  MoveIsLegal = True
  if StartRank < 1 or StartRank > 8 or StartFile < 1 or StartFile > 8 or FinishRank < 1 or FinishRank > 8 or FinishFile < 1 or FinishFile > 8:
...
def GetMove(StartSquare, FinishSquare):
  ...
  while length != 2:
    try:
      FinishSquare = int(input("Enter coordinates of square for the piece to move to (file first): "))
